...
public interface SongRepository extends JpaRepository<Song, Long> {
    ...
    Page<Song> findByTitleContainingIgnoreCaseOrArtistContainingIgnoreCaseOrGenreContainingIgnoreCase(
            String title, String artist, String genre, Pageable pageable
    );
}
